...
import PedidoInterpreteProcessoService from '@/entities/pedido-interprete-processo/pedido-interprete-processo.service';
...
new Vue({
  ...
  provide: {
    ...
    pedidoInterpreteProcessoService: () => new PedidoInterpreteProcessoService(),
    freelancerService: () => new FreelancerService(),
    empresaTerciariaService: () => new EmpresaTerciariaService(),
